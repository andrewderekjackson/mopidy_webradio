...
class DynamicMenuItem(MenuItem):
    '''A single menu item which can callback for a list of child menu items'''

    def __init__(self, title, refresh, *args):
        self._title = title
        self._items = None
